            ...
            <div>
                <div className="w-screen bg-gray-50">
                    <div className="mx-auto max-w-screen-xl px-2 py-10 flex flex-col items-center">
                        ...
                        <OrdersTable tableHeader={tableHeader} orders={orders} getStatusColor={getStatusColor} openAddMat={()=>setOpenModal(true)} tableType={"materials"}/>
                        
                    </div>
                </div>
            </div>
            <AddMaterialCmnd isVisible={openModal} onClose={()=>setOpenModal(false)}/>
        </Fragment >
    );
};
